...
abstract class FlutterFlowTheme {
  ...
  late Color oliveGreen;
  late Color brightRed;
  late Color darkBlueBlack;
  late Color yellowOrange;
  late Color lightGray;
  late Color softPink;
  late Color mediumBlue;
  late Color veryLightGray;
  late Color green;
  late Color pinkishRed;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF637317);
  late Color secondary = const Color(0xFF5A5E43);
  late Color tertiary = const Color(0xFFCACBCE);
  late Color alternate = const Color(0xFF4C4F35);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF180505);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFE0E0E0);
  late Color accent1 = const Color(0xFF525017);
  late Color accent2 = const Color(0xCE525017);
  late Color accent3 = const Color(0xFFCACBCE);
  late Color accent4 = const Color(0xFFF5F1E8);
  late Color success = const Color(0xFF4C4F35);
  late Color warning = const Color(0xFF5A5E43);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF637317);
  late Color secondary = const Color(0xCE525017);
  late Color tertiary = const Color(0xFF4C4F35);
  late Color alternate = const Color(0xFFCACBCE);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFE9DEDE);
  late Color primaryBackground = const Color(0xFF1A1A1A);
  late Color secondaryBackground = const Color(0xFF2A2A2A);
  late Color accent1 = const Color(0xFFCACBCE);
  late Color accent2 = const Color(0xFFF5F1E8);
  late Color accent3 = const Color(0xFF4C4F35);
  late Color accent4 = const Color(0xFF5A5E43);
  late Color success = const Color(0xFFCACBCE);
  late Color warning = const Color(0xFFF5F1E8);
