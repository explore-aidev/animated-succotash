                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'geijejj2' /* Summary of your weekly brews */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .titleMedium
                              .override(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '9cbhzkw9' /* How to pour Latte Art */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleLarge
                                          .override(
                                    ...
                                    Padding(
                                      ...
                                      child: AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'h778rnly' /* A wonderfully delicious 2 patt... */,
                                        ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'gbdkbbd8' /* Learn how to brew a delicious ... */,
                                        ),
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
