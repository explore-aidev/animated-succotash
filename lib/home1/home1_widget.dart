                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'gc4jam68' /* Summary of your weekly brews */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .titleMedium
                              .override(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '4x680070' /* How to pour Latte Art */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleLarge
                                          .override(
                                    ...
                                    Padding(
                                      ...
                                      child: AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'nn3cjxsk' /* A wonderfully delicious 2 patt... */,
                                        ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          '6labbivl' /* Learn how to brew a delicious ... */,
                                        ),
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
